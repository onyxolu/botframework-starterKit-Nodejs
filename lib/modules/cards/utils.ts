...
export const receiptCardExample: IReceiptCard = {
  buttons: [
    {
...
export const VideoCardExample: IVideoCard = {
...
export const signinCardExample: ISigninCard = {
  title: "BotFramework Sign in Card",
  text: "Sign in",
  url: "https://login.microsoftonline.com",
};

export const audioCardExample: IAudioCard = {
...
export const animationCardExample: IAnimationCard = {
  title: "Microsoft Bot Framework",
  subtitle: "Animation Card",
  image: [{ url: "https://i.giphy.com/Ki55RUbOV5njy.gif" }],
};

export const thumbnailCardExample: IThumbnailCard = {
...
export const heroCardExample: IHeroCard = {
  images: [
    "https://sec.ch9.ms/ch9/7ff5/e07cfef0-aa3b-40bb-9baa-7c9ef8ff7ff5/buildreactionbotframework_960.jpg",
  ],
...
export const carouselCardsExample: IHeroCard[] = [
  {
    images: [
      "https://sec.ch9.ms/ch9/7ff5/e07cfef0-aa3b-40bb-9baa-7c9ef8ff7ff5/buildreactionbotframework_960.jpg",
    ],
